...
//   // keep a ref to the trigger element so the flyout mouseenter can re-use it
//   // (set by the template via showAiFlyout(el))
//   private _aiTriggerEl: HTMLElement | null = null;

//   // showAiFlyout(el: HTMLElement): void {
//   //   if (this._hideTimer) { clearTimeout(this._hideTimer); this._hideTimer = null; }
//   //   this._aiTriggerEl = el;
...
//   this.aiFlyoutTop  = rect.top + window.scrollY + 'px';
//   this.aiFlyoutLeft = rect.right + window.scrollX + 10 + 'px';
...
//     this._hideTimer = setTimeout(() => { this.aiFlyoutOpen = false; }, 300);
//   }
...
//     }).subscribe({
//       next: (res: any) => {
//         this.products    = res.result    ?? res;
//         this.totalPages  = res.totalPages  ?? 1;
//         this.currentPage = res.page        ?? 1;
//         this.totalResult = res.totalResult ?? this.products.length;
//         this.loading     = false;
//       },
//       error: (err: any) => {
...
//         else if (i - l !== 1) rangeWithDots.push(-1); // -1 = dots
//       }
